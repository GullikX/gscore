...
CFILES=application.c block.c config.h editview.c filereader.c filewriter.c gscore.c gscore.h input.c main.c objectview.c renderer.c synth.c track.c util.c xevents.c
