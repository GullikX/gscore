...
CFILES=application.c config.h editview.c filereader.c filewriter.c gscore.c gscore.h input.c main.c objectview.c player.c renderer.c synth.c util.c xevents.c
